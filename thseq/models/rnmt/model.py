...
class RNMT(_Model):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--talking-heads', type=int, default=0)
        parser.add_argument('--relative-pos-k', type=int, default=0)
        parser.add_argument('--relative-pos-v', type=int, default=0)
        parser.add_argument('--encoder-embedding-add-pos', type=int, default=1)
        parser.add_argument('--decoder-embedding-add-pos', type=int, default=1)
